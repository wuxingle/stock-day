package com.stock.stockday.model;
...
@Data
@TableName("stock_day_yan_pan")
public class StockDayYanPanKMPTD implements Serializable {
    private static final long serialVersionUID = 1L;
    @TableId
    private String id;
    private String priceAndMaRelation;
    private String qian20TuXing;
    private String kdj;
