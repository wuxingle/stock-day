...
public class FindUtil6 {
    ...
    public static boolean duoTuXiangShangDapan2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1) {
        ...
        boolean result=dapanChang(stockDayAllListDaPan1);
        if (result) {
            //均线聚拢,开始多天向上
    ...
    public static boolean reset20Dapan4(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQiDapan6(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqiDapan8(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqiDapan9(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQiDapan7(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean jieQiDapan8(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean jieQiDapan9(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean jieQiDapan10(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean jieQiDapan11(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean jieQiDapan12(List<StockDayAll> stockDayAllList, List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        boolean result=dapanChang(stockDayAllListDaPan1);
    ...
    public static boolean dapanChang(List<StockDayAll> stockDayAllListDaPan1) {
        if (stockDayAllListDaPan1 == null || stockDayAllListDaPan1.size() == 0) {
            return false;
        }
        if (stockDayAllListDaPan1.get(0).getChangePoints()!=null) {
            if (stockDayAllListDaPan1.get(0).getChangePoints().compareTo(new BigDecimal(0)) <= 0) {
                return true;
            }
        }
        return false;
