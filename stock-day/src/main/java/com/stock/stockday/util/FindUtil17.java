...
public class FindUtil17 {
    ...
    public static boolean duoTuXiangShangDapan2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<ScienceEntity> scienceEntityListDaPan) {
        ...
        if (scienceEntityList.get(0).getPriceMa30() == null || scienceEntityList.get(0).getPriceMa20() == null || scienceEntityList.get(1).getPriceMa10() == null || scienceEntityList.get(0).getPriceMa10() == null || scienceEntityList.get(1).getPriceMa5() == null || scienceEntityList.get(7).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa10() == null) {
            return false;
        }
        try {
            boolean result = shangjishu20(scienceEntityListDaPan);
            if (result) {
                //均线聚拢,开始多天向上
    ...
    public static boolean jieQiDapan3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<ScienceEntity> scienceEntityListDaPan) {
        ...
        if (scienceEntityList.get(2).getPriceMa20() == null || scienceEntityList.get(2).getPriceMa30() == null || scienceEntityList.get(0).getPriceMa20() == null || scienceEntityList.get(0).getPriceMa30() == null || scienceEntityList.get(7).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa10() == null) {
            return false;
        }
        try {
            boolean result = shangjishu20(scienceEntityListDaPan);
    ...
    public static boolean reset20Dapan3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<ScienceEntity> scienceEntityListDaPan) {
        ...
        if (scienceEntityList.get(5).getPriceMa20() == null || scienceEntityList.get(5).getPriceMa30() == null || scienceEntityList.get(1).getPriceMa20() == null || scienceEntityList.get(1).getPriceMa30() == null || scienceEntityList.get(0).getPriceMa20() == null || scienceEntityList.get(0).getPriceMa30() == null || scienceEntityList.get(2).getPriceMa5() == null || stockDayAllList.get(2).getTopside() == null || scienceEntityList.get(5).getPriceMa5() == null || stockDayAllList.get(5).getTopside() == null || scienceEntityList.get(7).getPriceMa5() == null || scienceEntityList.get(7).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa10() == null) {
            return false;
        }
        try {
            boolean result = shangjishu20(scienceEntityListDaPan);
    ...
    public static boolean jieQiDapan7(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        try {
    ...
    public static boolean jieQiDapan8(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        try {
    ...
    public static boolean jieQiDapan9(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        try {
    ...
    public static boolean jieQiDapan11(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        try {
    ...
    public static boolean jieQiDapan12(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        try {
    ...
    public static boolean shangjishu20(List<ScienceEntity> scienceEntityListDaPan) {
        ...
        try {
            ...
            if (scienceEntityListDaPan.get(2).getK().compareTo(new BigDecimal(20)) <= 0 && scienceEntityListDaPan.get(1).getK().compareTo(new BigDecimal(20)) <= 0 && scienceEntityListDaPan.get(0).getK().compareTo(new BigDecimal(20)) <= 0) {
                if (scienceEntityListDaPan.get(2).getK().compareTo(scienceEntityListDaPan.get(2).getK()) >= 0 && scienceEntityListDaPan.get(1).getK().compareTo(scienceEntityListDaPan.get(0).getK()) >= 0) {
                    return true;
                }
            }
        } catch (Exception e) {
