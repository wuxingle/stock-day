...
public class FindUtil15 {
    ...
    public static boolean shang20(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        ...
        try{
        if (stockDayAllList.get(0).getClosingPrice()!=null&&stockDayAllList.get(1).getClosingPrice()!=null&&stockDayAllList.get(6).getClosingPrice()!=null&&stockDayAllList.get(2).getClosingPrice()!=null&&stockDayAllList.get(4).getClosingPrice()!=null&&stockDayAllList.get(3).getClosingPrice()!=null&&stockDayAllList.get(0).getOpeningPrice()!=null) {
            //前几天在5天线上 近5天下降
            BigDecimal xia6 = (stockDayAllList.get(0).getClosingPrice().subtract(stockDayAllList.get(6).getClosingPrice())).divide(stockDayAllList.get(0).getClosingPrice(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
            BigDecimal xia4 = (stockDayAllList.get(0).getClosingPrice().subtract(stockDayAllList.get(4).getClosingPrice())).divide(stockDayAllList.get(0).getClosingPrice(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
            BigDecimal xia3 = (stockDayAllList.get(0).getClosingPrice().subtract(stockDayAllList.get(3).getClosingPrice())).divide(stockDayAllList.get(0).getClosingPrice(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
            BigDecimal xia2 = (stockDayAllList.get(0).getClosingPrice().subtract(stockDayAllList.get(2).getClosingPrice())).divide(stockDayAllList.get(0).getClosingPrice(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
            if (xia6.compareTo(new BigDecimal(-1.5)) <= 0 && xia4.compareTo(new BigDecimal(-1)) <= 0 && xia3.compareTo(new BigDecimal(0)) <= 0 && xia2.compareTo(new BigDecimal(2)) <= 0 && xia2.compareTo(new BigDecimal(0)) >= 0) {
                //均线上
                BigDecimal ma30 = scienceEntityList.get(0).getPriceMa30().subtract(scienceEntityList.get(1).getPriceMa30());
                BigDecimal ma20 = scienceEntityList.get(0).getPriceMa20().subtract(scienceEntityList.get(1).getPriceMa20());
                if (ma30.compareTo(new BigDecimal(0)) >= 0 && ma20.compareTo(new BigDecimal(-0.03)) >= 0) {
