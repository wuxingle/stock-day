...
public class FindUtil4 {
    ...
    public static boolean duoTuXiangShangDapan2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        ...
        boolean result = jishujieqiKdj(stockDayAllListDaPan1,scienceEntityListDaPan);
        if (result) {
            //均线聚拢,开始多天向上
    ...
    public static boolean jishujieqiKdj(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
        ...
        KDJScienceVo kdjScienceVo = KDJUtil.getKDJScience1(scienceEntityList, changeEntityList);
        if (kdjScienceVo.getJincha() != null || kdjScienceVo.getXiangshang() != null || kdjScienceVo.getXiangshang80() != null || kdjScienceVo.getJincha80() != null || (kdjScienceVo.getKdjzhuhe().contains("20下钝化") || kdjScienceVo.getKdjzhuhe().contains("20下背离")) || kdjScienceVo.getXiangshang20() != null || kdjScienceVo.getJincha20() != null) {
            return true;
        }
        return false;
    }
