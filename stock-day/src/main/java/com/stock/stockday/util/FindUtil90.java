...
public class FindUtil90 {
    ...
    public static boolean jieQiDapan7(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan8(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan9(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan11(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan12(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
    ...
    public static boolean jieQiDapan13(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan14(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan15(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean jieQiDapan16(List<StockDayAll> stockDayAllList,List<ScienceEntity> scienceEntityList) {
        try {
            if (bptx(stockDayAllList)){
    ...
    public static boolean bptx(List<StockDayAll> stockDayAllList) {
