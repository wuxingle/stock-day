...
public class FindUtil21 {
    ...
    public static boolean shangjishu20(List<ScienceEntity> scienceEntityListDaPan) {
        ...
        try{
        //金叉
        if (scienceEntityListDaPan.get(0).getK().compareTo(new BigDecimal(50))<0&&scienceEntityListDaPan.get(0).getK().compareTo(new BigDecimal(20))>0){
