...
public class FindUtil {
    ...
    public static boolean reset20(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        ...
        if (scienceEntityList.get(4).getPriceMa30()==null||scienceEntityList.get(1).getPriceMa30()==null||scienceEntityList.get(0).getPriceMa30()==null||scienceEntityList.get(7).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa5() == null || scienceEntityList.get(0).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa60() == null || scienceEntityList.get(2).getPriceMa10() == null || scienceEntityList.get(5).getPriceMa10() == null) {
            return false;
        }
        //均线上
    ...
    public static boolean jieQi(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQi2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean duoTuXiangShang2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean shengV2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean reset202(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQi3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi4(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi5(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean duoTuXiangShang3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean shengV3(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean reset203(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQi4(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi6(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqi7(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQi5(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<SunEntity> sunEntityList = new ArrayList<>();
    ...
    public static boolean jieQi6(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<SunEntity> sunEntityList = new ArrayList<>();
    ...
    public static boolean jieQi7(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<SunEntity> sunEntityList = new ArrayList<>();
    ...
    public static boolean jieQi8(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<SunEntity> sunEntityList = new ArrayList<>();
    ...
    public static boolean jieQi9(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<CengDieEntity> cengDieEntityList = new ArrayList<>();
    ...
    public static boolean jieQi10(List<StockDayAll> stockDayAllList) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        List<SunEntity> sunEntityList = new ArrayList<>();
    ...
    public static boolean duoTuXiangShangDapan1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        ...
        boolean result=jishujieqi(stockDayAllListDaPan1,scienceEntityListDaPan);
        if (result) {
            //均线聚拢,开始多天向上
            BigDecimal li10 = (scienceEntityList.get(0).getPriceMa10().subtract(scienceEntityList.get(0).getPriceMa5())).divide(scienceEntityList.get(0).getPriceMa5(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
            BigDecimal li20 = (scienceEntityList.get(0).getPriceMa20().subtract(scienceEntityList.get(0).getPriceMa5())).divide(scienceEntityList.get(0).getPriceMa5(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
    ...
    public static boolean shengVDapan1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean reset20Dapan1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQiDapan1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqiDapan1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jishujieqiDapan2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
    ...
    public static boolean jieQiDapan2(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList, List<StockDayAll> stockDayAllListDaPan1, List<ScienceEntity> scienceEntityListDaPan) {
        if (stockDayAllList == null || stockDayAllList.size() == 0) {
            return false;
        }
        if (scienceEntityList == null || scienceEntityList.size() == 0) {
