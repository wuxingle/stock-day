...
public class FindUtil {
    ...
    public static boolean jieQi(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        ...
        if (liclose.compareTo(new BigDecimal(20)) < 0) {
            //前3天均线开始聚拢
    ...
    public static boolean jishujieqi(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        ...
        if (kdjScienceVo.getJincha() != null || kdjScienceVo.getXiangshang80() != null || kdjScienceVo.getSicha80() != null || (kdjScienceVo.getKdjzhuhe().contains("20下钝化") || kdjScienceVo.getKdjzhuhe().contains("20下背离")) || kdjScienceVo.getXiangshang20() != null || kdjScienceVo.getSicha20() != null) {
            if (macdScienceVo.getShangchuan0zhou() != null || macdScienceVo.getZhoufujinjincha() != null || macdScienceVo.getZhouxiasicha() != null || macdScienceVo.getZhoushangsicha() != null || macdScienceVo.getZhouxiaxiangshang() != null || macdScienceVo.getZhoushnagxiangshang() != null) {
                //前3天均线开始聚拢
                BigDecimal li103 = (scienceEntityList.get(2).getPriceMa10().subtract(scienceEntityList.get(2).getPriceMa5())).divide(scienceEntityList.get(2).getPriceMa5(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
                BigDecimal li203 = (scienceEntityList.get(2).getPriceMa20().subtract(scienceEntityList.get(2).getPriceMa5())).divide(scienceEntityList.get(2).getPriceMa5(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
                BigDecimal li303 = (scienceEntityList.get(2).getPriceMa30().subtract(scienceEntityList.get(2).getPriceMa5())).divide(scienceEntityList.get(2).getPriceMa5(), 4, RoundingMode.HALF_UP).multiply(new BigDecimal(100));
    ...
    public static boolean jishujieqi1(List<StockDayAll> stockDayAllList, List<ScienceEntity> scienceEntityList) {
        ...
        KDJScienceVo kdjScienceVo = KDJUtil.getKDJScience1(scienceEntityList, changeEntityList);
        MACDScienceVo macdScienceVo = MACDUtil.getMACDScience1(scienceEntityList);
        if (kdjScienceVo.getJincha() != null || kdjScienceVo.getSicha80() != null || kdjScienceVo.getSicha20() != null) {
