...
@Service
public class DayScience6018Function {
    @Autowired
    private StockDayScience6018Service stockDayScience6018Service;
    @Autowired
    private StockDay6018Service stockDay6018Service;

    public boolean dayScience6018Function(StockCode stockCode){
        List<StockDay6018> stockDay6018List = stockDay6018Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6018> stockDayScience6018List = new ArrayList<>();
        ...
        for (StockDay6018 stockDay6018 : stockDay6018List) {
            ...
            macdEntity.setClosingPrice(stockDay6018.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6018.getClosingPrice());
            kdjEntity.setFoot(stockDay6018.getFoot());
            kdjEntity.setTopside(stockDay6018.getTopside());
            kdjEntity.setDate(stockDay6018.getDate());
            ...
            if (stockDay6018.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6018.getChangePoints());
            }
            rsiEntity.setDate(stockDay6018.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6018.getClosingPrice());
            biasEntity.setDate(stockDay6018.getDate());
            ...
            cciEntity.setDate(stockDay6018.getDate());
            cciEntity.setClosingPrice(stockDay6018.getClosingPrice());
            cciEntity.setFoot(stockDay6018.getFoot());
            cciEntity.setTopside(stockDay6018.getTopside());
            ...
            wrEntity.setDate(stockDay6018.getDate());
            wrEntity.setClosingPrice(stockDay6018.getClosingPrice());
            wrEntity.setFoot(stockDay6018.getFoot());
            wrEntity.setTopside(stockDay6018.getTopside());
            ...
            bollEntity.setDate(stockDay6018.getDate());
            bollEntity.setClosingPrice(stockDay6018.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6018.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6018.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6018.getDate());
            priceEntity.setClosingPrice(stockDay6018.getClosingPrice());
