...
@Service
public class DayScience0001Function {
    @Autowired
    private StockDayScience0001Service stockDayScience0001Service;
    @Autowired
    private StockDay0001Service stockDay0001Service;

    public boolean dayScience0001Function(StockCode stockCode){
        List<StockDay0001> stockDay0001List = stockDay0001Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0001> stockDayScience0001List = new ArrayList<>();
        ...
        for (StockDay0001 stockDay0001 : stockDay0001List) {
            ...
            macdEntity.setClosingPrice(stockDay0001.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0001.getClosingPrice());
            kdjEntity.setFoot(stockDay0001.getFoot());
            kdjEntity.setTopside(stockDay0001.getTopside());
            kdjEntity.setDate(stockDay0001.getDate());
            ...
            if (stockDay0001.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0001.getChangePoints());
            }
            rsiEntity.setDate(stockDay0001.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0001.getClosingPrice());
            biasEntity.setDate(stockDay0001.getDate());
            ...
            cciEntity.setDate(stockDay0001.getDate());
            cciEntity.setClosingPrice(stockDay0001.getClosingPrice());
            cciEntity.setFoot(stockDay0001.getFoot());
            cciEntity.setTopside(stockDay0001.getTopside());
            ...
            wrEntity.setDate(stockDay0001.getDate());
            wrEntity.setClosingPrice(stockDay0001.getClosingPrice());
            wrEntity.setFoot(stockDay0001.getFoot());
            wrEntity.setTopside(stockDay0001.getTopside());
            ...
            bollEntity.setDate(stockDay0001.getDate());
            bollEntity.setClosingPrice(stockDay0001.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0001.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0001.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0001.getDate());
            priceEntity.setClosingPrice(stockDay0001.getClosingPrice());
