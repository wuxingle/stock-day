...
@Service
public class DayScience6011Function {
    @Autowired
    private StockDayScience6011Service stockDayScience6011Service;
    @Autowired
    private StockDay6011Service stockDay6011Service;

    public boolean dayScience6011Function(StockCode stockCode){
        List<StockDay6011> stockDay6011List = stockDay6011Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6011> stockDayScience6011List = new ArrayList<>();
        ...
        for (StockDay6011 stockDay6011 : stockDay6011List) {
            ...
            macdEntity.setClosingPrice(stockDay6011.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6011.getClosingPrice());
            kdjEntity.setFoot(stockDay6011.getFoot());
            kdjEntity.setTopside(stockDay6011.getTopside());
            kdjEntity.setDate(stockDay6011.getDate());
            ...
            if (stockDay6011.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6011.getChangePoints());
            }
            rsiEntity.setDate(stockDay6011.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6011.getClosingPrice());
            biasEntity.setDate(stockDay6011.getDate());
            ...
            cciEntity.setDate(stockDay6011.getDate());
            cciEntity.setClosingPrice(stockDay6011.getClosingPrice());
            cciEntity.setFoot(stockDay6011.getFoot());
            cciEntity.setTopside(stockDay6011.getTopside());
            ...
            wrEntity.setDate(stockDay6011.getDate());
            wrEntity.setClosingPrice(stockDay6011.getClosingPrice());
            wrEntity.setFoot(stockDay6011.getFoot());
            wrEntity.setTopside(stockDay6011.getTopside());
            ...
            bollEntity.setDate(stockDay6011.getDate());
            bollEntity.setClosingPrice(stockDay6011.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6011.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6011.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6011.getDate());
            priceEntity.setClosingPrice(stockDay6011.getClosingPrice());
