...
@Service
public class DayScience6004Function {
    @Autowired
    private StockDayScience6004Service stockDayScience6004Service;
    @Autowired
    private StockDay6004Service stockDay6004Service;

    public boolean dayScience6004Function(StockCode stockCode){
        List<StockDay6004> stockDay6004List = stockDay6004Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6004> stockDayScience6004List = new ArrayList<>();
        ...
        for (StockDay6004 stockDay6004 : stockDay6004List) {
            ...
            macdEntity.setClosingPrice(stockDay6004.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6004.getClosingPrice());
            kdjEntity.setFoot(stockDay6004.getFoot());
            kdjEntity.setTopside(stockDay6004.getTopside());
            kdjEntity.setDate(stockDay6004.getDate());
            ...
            if (stockDay6004.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6004.getChangePoints());
            }
            rsiEntity.setDate(stockDay6004.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6004.getClosingPrice());
            biasEntity.setDate(stockDay6004.getDate());
            ...
            cciEntity.setDate(stockDay6004.getDate());
            cciEntity.setClosingPrice(stockDay6004.getClosingPrice());
            cciEntity.setFoot(stockDay6004.getFoot());
            cciEntity.setTopside(stockDay6004.getTopside());
            ...
            wrEntity.setDate(stockDay6004.getDate());
            wrEntity.setClosingPrice(stockDay6004.getClosingPrice());
            wrEntity.setFoot(stockDay6004.getFoot());
            wrEntity.setTopside(stockDay6004.getTopside());
            ...
            bollEntity.setDate(stockDay6004.getDate());
            bollEntity.setClosingPrice(stockDay6004.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6004.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6004.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6004.getDate());
            priceEntity.setClosingPrice(stockDay6004.getClosingPrice());
