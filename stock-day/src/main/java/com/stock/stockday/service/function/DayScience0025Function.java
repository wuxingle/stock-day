...
@Service
public class DayScience0025Function {
    @Autowired
    private StockDayScience0025Service stockDayScience0025Service;
    @Autowired
    private StockDay0025Service stockDay0025Service;

    public boolean dayScience0025Function(StockCode stockCode){
        List<StockDay0025> stockDay0025List = stockDay0025Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0025> stockDayScience0025List = new ArrayList<>();
        ...
        for (StockDay0025 stockDay0025 : stockDay0025List) {
            ...
            macdEntity.setClosingPrice(stockDay0025.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0025.getClosingPrice());
            kdjEntity.setFoot(stockDay0025.getFoot());
            kdjEntity.setTopside(stockDay0025.getTopside());
            kdjEntity.setDate(stockDay0025.getDate());
            ...
            if (stockDay0025.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0025.getChangePoints());
            }
            rsiEntity.setDate(stockDay0025.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0025.getClosingPrice());
            biasEntity.setDate(stockDay0025.getDate());
            ...
            cciEntity.setDate(stockDay0025.getDate());
            cciEntity.setClosingPrice(stockDay0025.getClosingPrice());
            cciEntity.setFoot(stockDay0025.getFoot());
            cciEntity.setTopside(stockDay0025.getTopside());
            ...
            wrEntity.setDate(stockDay0025.getDate());
            wrEntity.setClosingPrice(stockDay0025.getClosingPrice());
            wrEntity.setFoot(stockDay0025.getFoot());
            wrEntity.setTopside(stockDay0025.getTopside());
            ...
            bollEntity.setDate(stockDay0025.getDate());
            bollEntity.setClosingPrice(stockDay0025.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0025.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0025.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0025.getDate());
            priceEntity.setClosingPrice(stockDay0025.getClosingPrice());
