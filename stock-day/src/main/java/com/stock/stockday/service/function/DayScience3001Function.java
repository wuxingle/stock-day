...
@Service
public class DayScience3001Function {
    @Autowired
    private StockDayScience3001Service stockDayScience3001Service;
    @Autowired
    private StockDay3001Service stockDay3001Service;

    public boolean dayScience3001Function(StockCode stockCode){
        List<StockDay3001> stockDay3001List = stockDay3001Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience3001> stockDayScience3001List = new ArrayList<>();
        ...
        for (StockDay3001 stockDay3001 : stockDay3001List) {
            ...
            macdEntity.setClosingPrice(stockDay3001.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay3001.getClosingPrice());
            kdjEntity.setFoot(stockDay3001.getFoot());
            kdjEntity.setTopside(stockDay3001.getTopside());
            kdjEntity.setDate(stockDay3001.getDate());
            ...
            if (stockDay3001.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay3001.getChangePoints());
            }
            rsiEntity.setDate(stockDay3001.getDate());
            ...
            biasEntity.setClosingPrice(stockDay3001.getClosingPrice());
            biasEntity.setDate(stockDay3001.getDate());
            ...
            cciEntity.setDate(stockDay3001.getDate());
            cciEntity.setClosingPrice(stockDay3001.getClosingPrice());
            cciEntity.setFoot(stockDay3001.getFoot());
            cciEntity.setTopside(stockDay3001.getTopside());
            ...
            wrEntity.setDate(stockDay3001.getDate());
            wrEntity.setClosingPrice(stockDay3001.getClosingPrice());
            wrEntity.setFoot(stockDay3001.getFoot());
            wrEntity.setTopside(stockDay3001.getTopside());
            ...
            bollEntity.setDate(stockDay3001.getDate());
            bollEntity.setClosingPrice(stockDay3001.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay3001.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay3001.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay3001.getDate());
            priceEntity.setClosingPrice(stockDay3001.getClosingPrice());
