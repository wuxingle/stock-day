...
@Service
public class DayScience399Function {
    @Autowired
    private StockDayScience399Service stockDayScience399Service;
    @Autowired
    private StockDay399Service stockDay399Service;

    public boolean dayScience399Function(StockCode stockCode){
        List<StockDay399> stockDay399List = stockDay399Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience399> stockDayScience399List = new ArrayList<>();
        ...
        for (StockDay399 stockDay399 : stockDay399List) {
            ...
            macdEntity.setClosingPrice(stockDay399.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay399.getClosingPrice());
            kdjEntity.setFoot(stockDay399.getFoot());
            kdjEntity.setTopside(stockDay399.getTopside());
            kdjEntity.setDate(stockDay399.getDate());
            ...
            if (stockDay399.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay399.getChangePoints());
            }
            rsiEntity.setDate(stockDay399.getDate());
            ...
            biasEntity.setClosingPrice(stockDay399.getClosingPrice());
            biasEntity.setDate(stockDay399.getDate());
            ...
            cciEntity.setDate(stockDay399.getDate());
            cciEntity.setClosingPrice(stockDay399.getClosingPrice());
            cciEntity.setFoot(stockDay399.getFoot());
            cciEntity.setTopside(stockDay399.getTopside());
            ...
            wrEntity.setDate(stockDay399.getDate());
            wrEntity.setClosingPrice(stockDay399.getClosingPrice());
            wrEntity.setFoot(stockDay399.getFoot());
            wrEntity.setTopside(stockDay399.getTopside());
            ...
            bollEntity.setDate(stockDay399.getDate());
            bollEntity.setClosingPrice(stockDay399.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay399.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay399.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay399.getDate());
            priceEntity.setClosingPrice(stockDay399.getClosingPrice());
