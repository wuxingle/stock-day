...
@Service
public class DayScience0004Function {
    @Autowired
    private StockDayScience0004Service stockDayScience0004Service;
    @Autowired
    private StockDay0004Service stockDay0004Service;

    public boolean dayScience0004Function(StockCode stockCode){
        List<StockDay0004> stockDay0004List = stockDay0004Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0004> stockDayScience0004List = new ArrayList<>();
        ...
        for (StockDay0004 stockDay0004 : stockDay0004List) {
            ...
            macdEntity.setClosingPrice(stockDay0004.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0004.getClosingPrice());
            kdjEntity.setFoot(stockDay0004.getFoot());
            kdjEntity.setTopside(stockDay0004.getTopside());
            kdjEntity.setDate(stockDay0004.getDate());
            ...
            if (stockDay0004.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0004.getChangePoints());
            }
            rsiEntity.setDate(stockDay0004.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0004.getClosingPrice());
            biasEntity.setDate(stockDay0004.getDate());
            ...
            cciEntity.setDate(stockDay0004.getDate());
            cciEntity.setClosingPrice(stockDay0004.getClosingPrice());
            cciEntity.setFoot(stockDay0004.getFoot());
            cciEntity.setTopside(stockDay0004.getTopside());
            ...
            wrEntity.setDate(stockDay0004.getDate());
            wrEntity.setClosingPrice(stockDay0004.getClosingPrice());
            wrEntity.setFoot(stockDay0004.getFoot());
            wrEntity.setTopside(stockDay0004.getTopside());
            ...
            bollEntity.setDate(stockDay0004.getDate());
            bollEntity.setClosingPrice(stockDay0004.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0004.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0004.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0004.getDate());
            priceEntity.setClosingPrice(stockDay0004.getClosingPrice());
