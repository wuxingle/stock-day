...
@Service
public class DayScience0024Function {
    @Autowired
    private StockDayScience0024Service stockDayScience0024Service;
    @Autowired
    private StockDay0024Service stockDay0024Service;

    public boolean dayScience0024Function(StockCode stockCode){
        List<StockDay0024> stockDay0024List = stockDay0024Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0024> stockDayScience0024List = new ArrayList<>();
        ...
        for (StockDay0024 stockDay0024 : stockDay0024List) {
            ...
            macdEntity.setClosingPrice(stockDay0024.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0024.getClosingPrice());
            kdjEntity.setFoot(stockDay0024.getFoot());
            kdjEntity.setTopside(stockDay0024.getTopside());
            kdjEntity.setDate(stockDay0024.getDate());
            ...
            if (stockDay0024.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0024.getChangePoints());
            }
            rsiEntity.setDate(stockDay0024.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0024.getClosingPrice());
            biasEntity.setDate(stockDay0024.getDate());
            ...
            cciEntity.setDate(stockDay0024.getDate());
            cciEntity.setClosingPrice(stockDay0024.getClosingPrice());
            cciEntity.setFoot(stockDay0024.getFoot());
            cciEntity.setTopside(stockDay0024.getTopside());
            ...
            wrEntity.setDate(stockDay0024.getDate());
            wrEntity.setClosingPrice(stockDay0024.getClosingPrice());
            wrEntity.setFoot(stockDay0024.getFoot());
            wrEntity.setTopside(stockDay0024.getTopside());
            ...
            bollEntity.setDate(stockDay0024.getDate());
            bollEntity.setClosingPrice(stockDay0024.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0024.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0024.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0024.getDate());
            priceEntity.setClosingPrice(stockDay0024.getClosingPrice());
