...
@Service
public class DayScience6006Function {
    @Autowired
    private StockDayScience6006Service stockDayScience6006Service;
    @Autowired
    private StockDay6006Service stockDay6006Service;

    public boolean dayScience6006Function(StockCode stockCode){
        List<StockDay6006> stockDay6006List = stockDay6006Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6006> stockDayScience6006List = new ArrayList<>();
        ...
        for (StockDay6006 stockDay6006 : stockDay6006List) {
            ...
            macdEntity.setClosingPrice(stockDay6006.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6006.getClosingPrice());
            kdjEntity.setFoot(stockDay6006.getFoot());
            kdjEntity.setTopside(stockDay6006.getTopside());
            kdjEntity.setDate(stockDay6006.getDate());
            ...
            if (stockDay6006.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6006.getChangePoints());
            }
            rsiEntity.setDate(stockDay6006.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6006.getClosingPrice());
            biasEntity.setDate(stockDay6006.getDate());
            ...
            cciEntity.setDate(stockDay6006.getDate());
            cciEntity.setClosingPrice(stockDay6006.getClosingPrice());
            cciEntity.setFoot(stockDay6006.getFoot());
            cciEntity.setTopside(stockDay6006.getTopside());
            ...
            wrEntity.setDate(stockDay6006.getDate());
            wrEntity.setClosingPrice(stockDay6006.getClosingPrice());
            wrEntity.setFoot(stockDay6006.getFoot());
            wrEntity.setTopside(stockDay6006.getTopside());
            ...
            bollEntity.setDate(stockDay6006.getDate());
            bollEntity.setClosingPrice(stockDay6006.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6006.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6006.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6006.getDate());
            priceEntity.setClosingPrice(stockDay6006.getClosingPrice());
