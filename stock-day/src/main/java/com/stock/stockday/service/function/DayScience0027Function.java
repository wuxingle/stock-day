...
@Service
public class DayScience0027Function {
    @Autowired
    private StockDayScience0027Service stockDayScience0027Service;
    @Autowired
    private StockDay0027Service stockDay0027Service;

    public boolean dayScience0027Function(StockCode stockCode){
        List<StockDay0027> stockDay0027List = stockDay0027Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0027> stockDayScience0027List = new ArrayList<>();
        ...
        for (StockDay0027 stockDay0027 : stockDay0027List) {
            ...
            macdEntity.setClosingPrice(stockDay0027.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0027.getClosingPrice());
            kdjEntity.setFoot(stockDay0027.getFoot());
            kdjEntity.setTopside(stockDay0027.getTopside());
            kdjEntity.setDate(stockDay0027.getDate());
            ...
            if (stockDay0027.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0027.getChangePoints());
            }
            rsiEntity.setDate(stockDay0027.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0027.getClosingPrice());
            biasEntity.setDate(stockDay0027.getDate());
            ...
            cciEntity.setDate(stockDay0027.getDate());
            cciEntity.setClosingPrice(stockDay0027.getClosingPrice());
            cciEntity.setFoot(stockDay0027.getFoot());
            cciEntity.setTopside(stockDay0027.getTopside());
            ...
            wrEntity.setDate(stockDay0027.getDate());
            wrEntity.setClosingPrice(stockDay0027.getClosingPrice());
            wrEntity.setFoot(stockDay0027.getFoot());
            wrEntity.setTopside(stockDay0027.getTopside());
            ...
            bollEntity.setDate(stockDay0027.getDate());
            bollEntity.setClosingPrice(stockDay0027.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0027.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0027.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0027.getDate());
            priceEntity.setClosingPrice(stockDay0027.getClosingPrice());
