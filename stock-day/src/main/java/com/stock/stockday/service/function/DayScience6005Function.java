...
@Service
public class DayScience6005Function {
    @Autowired
    private StockDayScience6005Service stockDayScience6005Service;
    @Autowired
    private StockDay6005Service stockDay6005Service;

    public boolean dayScience6005Function(StockCode stockCode){
        List<StockDay6005> stockDay6005List = stockDay6005Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6005> stockDayScience6005List = new ArrayList<>();
        ...
        for (StockDay6005 stockDay6005 : stockDay6005List) {
            ...
            macdEntity.setClosingPrice(stockDay6005.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6005.getClosingPrice());
            kdjEntity.setFoot(stockDay6005.getFoot());
            kdjEntity.setTopside(stockDay6005.getTopside());
            kdjEntity.setDate(stockDay6005.getDate());
            ...
            if (stockDay6005.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6005.getChangePoints());
            }
            rsiEntity.setDate(stockDay6005.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6005.getClosingPrice());
            biasEntity.setDate(stockDay6005.getDate());
            ...
            cciEntity.setDate(stockDay6005.getDate());
            cciEntity.setClosingPrice(stockDay6005.getClosingPrice());
            cciEntity.setFoot(stockDay6005.getFoot());
            cciEntity.setTopside(stockDay6005.getTopside());
            ...
            wrEntity.setDate(stockDay6005.getDate());
            wrEntity.setClosingPrice(stockDay6005.getClosingPrice());
            wrEntity.setFoot(stockDay6005.getFoot());
            wrEntity.setTopside(stockDay6005.getTopside());
            ...
            bollEntity.setDate(stockDay6005.getDate());
            bollEntity.setClosingPrice(stockDay6005.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6005.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6005.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6005.getDate());
            priceEntity.setClosingPrice(stockDay6005.getClosingPrice());
