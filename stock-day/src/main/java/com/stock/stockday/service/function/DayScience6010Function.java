...
@Service
public class DayScience6010Function {
    @Autowired
    private StockDayScience6010Service stockDayScience6010Service;
    @Autowired
    private StockDay6010Service stockDay6010Service;

    public boolean dayScience6010Function(StockCode stockCode){
        List<StockDay6010> stockDay6010List = stockDay6010Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6010> stockDayScience6010List = new ArrayList<>();
        ...
        for (StockDay6010 stockDay6010 : stockDay6010List) {
            ...
            macdEntity.setClosingPrice(stockDay6010.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6010.getClosingPrice());
            kdjEntity.setFoot(stockDay6010.getFoot());
            kdjEntity.setTopside(stockDay6010.getTopside());
            kdjEntity.setDate(stockDay6010.getDate());
            ...
            if (stockDay6010.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6010.getChangePoints());
            }
            rsiEntity.setDate(stockDay6010.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6010.getClosingPrice());
            biasEntity.setDate(stockDay6010.getDate());
            ...
            cciEntity.setDate(stockDay6010.getDate());
            cciEntity.setClosingPrice(stockDay6010.getClosingPrice());
            cciEntity.setFoot(stockDay6010.getFoot());
            cciEntity.setTopside(stockDay6010.getTopside());
            ...
            wrEntity.setDate(stockDay6010.getDate());
            wrEntity.setClosingPrice(stockDay6010.getClosingPrice());
            wrEntity.setFoot(stockDay6010.getFoot());
            wrEntity.setTopside(stockDay6010.getTopside());
            ...
            bollEntity.setDate(stockDay6010.getDate());
            bollEntity.setClosingPrice(stockDay6010.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6010.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6010.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6010.getDate());
            priceEntity.setClosingPrice(stockDay6010.getClosingPrice());
