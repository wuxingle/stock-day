...
@Service
public class DayScience3004Function {
    @Autowired
    private StockDayScience3004Service stockDayScience3004Service;
    @Autowired
    private StockDay3004Service stockDay3004Service;

    public boolean dayScience3004Function(StockCode stockCode){
        List<StockDay3004> stockDay3004List = stockDay3004Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience3004> stockDayScience3004List = new ArrayList<>();
        ...
        for (StockDay3004 stockDay3004 : stockDay3004List) {
            ...
            macdEntity.setClosingPrice(stockDay3004.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay3004.getClosingPrice());
            kdjEntity.setFoot(stockDay3004.getFoot());
            kdjEntity.setTopside(stockDay3004.getTopside());
            kdjEntity.setDate(stockDay3004.getDate());
            ...
            if (stockDay3004.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay3004.getChangePoints());
            }
            rsiEntity.setDate(stockDay3004.getDate());
            ...
            biasEntity.setClosingPrice(stockDay3004.getClosingPrice());
            biasEntity.setDate(stockDay3004.getDate());
            ...
            cciEntity.setDate(stockDay3004.getDate());
            cciEntity.setClosingPrice(stockDay3004.getClosingPrice());
            cciEntity.setFoot(stockDay3004.getFoot());
            cciEntity.setTopside(stockDay3004.getTopside());
            ...
            wrEntity.setDate(stockDay3004.getDate());
            wrEntity.setClosingPrice(stockDay3004.getClosingPrice());
            wrEntity.setFoot(stockDay3004.getFoot());
            wrEntity.setTopside(stockDay3004.getTopside());
            ...
            bollEntity.setDate(stockDay3004.getDate());
            bollEntity.setClosingPrice(stockDay3004.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay3004.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay3004.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay3004.getDate());
            priceEntity.setClosingPrice(stockDay3004.getClosingPrice());
