...
@Service
public class DayScience0021Function {
    @Autowired
    private StockDayScience0021Service stockDayScience0021Service;
    @Autowired
    private StockDay0021Service stockDay0021Service;

    public boolean dayScience0021Function(StockCode stockCode){
        List<StockDay0021> stockDay0021List = stockDay0021Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0021> stockDayScience0021List = new ArrayList<>();
        ...
        for (StockDay0021 stockDay0021 : stockDay0021List) {
            ...
            macdEntity.setClosingPrice(stockDay0021.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0021.getClosingPrice());
            kdjEntity.setFoot(stockDay0021.getFoot());
            kdjEntity.setTopside(stockDay0021.getTopside());
            kdjEntity.setDate(stockDay0021.getDate());
            ...
            if (stockDay0021.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0021.getChangePoints());
            }
            rsiEntity.setDate(stockDay0021.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0021.getClosingPrice());
            biasEntity.setDate(stockDay0021.getDate());
            ...
            cciEntity.setDate(stockDay0021.getDate());
            cciEntity.setClosingPrice(stockDay0021.getClosingPrice());
            cciEntity.setFoot(stockDay0021.getFoot());
            cciEntity.setTopside(stockDay0021.getTopside());
            ...
            wrEntity.setDate(stockDay0021.getDate());
            wrEntity.setClosingPrice(stockDay0021.getClosingPrice());
            wrEntity.setFoot(stockDay0021.getFoot());
            wrEntity.setTopside(stockDay0021.getTopside());
            ...
            bollEntity.setDate(stockDay0021.getDate());
            bollEntity.setClosingPrice(stockDay0021.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0021.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0021.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0021.getDate());
            priceEntity.setClosingPrice(stockDay0021.getClosingPrice());
