...
@Service
public class DayScience0028Function {
    @Autowired
    private StockDayScience0028Service stockDayScience0028Service;
    @Autowired
    private StockDay0028Service stockDay0028Service;

    public boolean dayScience0028Function(StockCode stockCode){
        List<StockDay0028> stockDay0028List = stockDay0028Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0028> stockDayScience0028List = new ArrayList<>();
        ...
        for (StockDay0028 stockDay0028 : stockDay0028List) {
            ...
            macdEntity.setClosingPrice(stockDay0028.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0028.getClosingPrice());
            kdjEntity.setFoot(stockDay0028.getFoot());
            kdjEntity.setTopside(stockDay0028.getTopside());
            kdjEntity.setDate(stockDay0028.getDate());
            ...
            if (stockDay0028.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0028.getChangePoints());
            }
            rsiEntity.setDate(stockDay0028.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0028.getClosingPrice());
            biasEntity.setDate(stockDay0028.getDate());
            ...
            cciEntity.setDate(stockDay0028.getDate());
            cciEntity.setClosingPrice(stockDay0028.getClosingPrice());
            cciEntity.setFoot(stockDay0028.getFoot());
            cciEntity.setTopside(stockDay0028.getTopside());
            ...
            wrEntity.setDate(stockDay0028.getDate());
            wrEntity.setClosingPrice(stockDay0028.getClosingPrice());
            wrEntity.setFoot(stockDay0028.getFoot());
            wrEntity.setTopside(stockDay0028.getTopside());
            ...
            bollEntity.setDate(stockDay0028.getDate());
            bollEntity.setClosingPrice(stockDay0028.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0028.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0028.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0028.getDate());
            priceEntity.setClosingPrice(stockDay0028.getClosingPrice());
