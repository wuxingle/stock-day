...
@Service
public class DayScience6008Function {
    @Autowired
    private StockDayScience6008Service stockDayScience6008Service;
    @Autowired
    private StockDay6008Service stockDay6008Service;

    public boolean dayScience6008Function(StockCode stockCode){
        List<StockDay6008> stockDay6008List = stockDay6008Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6008> stockDayScience6008List = new ArrayList<>();
        ...
        for (StockDay6008 stockDay6008 : stockDay6008List) {
            ...
            macdEntity.setClosingPrice(stockDay6008.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6008.getClosingPrice());
            kdjEntity.setFoot(stockDay6008.getFoot());
            kdjEntity.setTopside(stockDay6008.getTopside());
            kdjEntity.setDate(stockDay6008.getDate());
            ...
            if (stockDay6008.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6008.getChangePoints());
            }
            rsiEntity.setDate(stockDay6008.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6008.getClosingPrice());
            biasEntity.setDate(stockDay6008.getDate());
            ...
            cciEntity.setDate(stockDay6008.getDate());
            cciEntity.setClosingPrice(stockDay6008.getClosingPrice());
            cciEntity.setFoot(stockDay6008.getFoot());
            cciEntity.setTopside(stockDay6008.getTopside());
            ...
            wrEntity.setDate(stockDay6008.getDate());
            wrEntity.setClosingPrice(stockDay6008.getClosingPrice());
            wrEntity.setFoot(stockDay6008.getFoot());
            wrEntity.setTopside(stockDay6008.getTopside());
            ...
            bollEntity.setDate(stockDay6008.getDate());
            bollEntity.setClosingPrice(stockDay6008.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6008.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6008.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6008.getDate());
            priceEntity.setClosingPrice(stockDay6008.getClosingPrice());
