...
@Service
public class DayScience0022Function {
    @Autowired
    private StockDayScience0022Service stockDayScience0022Service;
    @Autowired
    private StockDay0022Service stockDay0022Service;

    public boolean dayScience0022Function(StockCode stockCode){
        List<StockDay0022> stockDay0022List = stockDay0022Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0022> stockDayScience0022List = new ArrayList<>();
        ...
        for (StockDay0022 stockDay0022 : stockDay0022List) {
            ...
            macdEntity.setClosingPrice(stockDay0022.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0022.getClosingPrice());
            kdjEntity.setFoot(stockDay0022.getFoot());
            kdjEntity.setTopside(stockDay0022.getTopside());
            kdjEntity.setDate(stockDay0022.getDate());
            ...
            if (stockDay0022.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0022.getChangePoints());
            }
            rsiEntity.setDate(stockDay0022.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0022.getClosingPrice());
            biasEntity.setDate(stockDay0022.getDate());
            ...
            cciEntity.setDate(stockDay0022.getDate());
            cciEntity.setClosingPrice(stockDay0022.getClosingPrice());
            cciEntity.setFoot(stockDay0022.getFoot());
            cciEntity.setTopside(stockDay0022.getTopside());
            ...
            wrEntity.setDate(stockDay0022.getDate());
            wrEntity.setClosingPrice(stockDay0022.getClosingPrice());
            wrEntity.setFoot(stockDay0022.getFoot());
            wrEntity.setTopside(stockDay0022.getTopside());
            ...
            bollEntity.setDate(stockDay0022.getDate());
            bollEntity.setClosingPrice(stockDay0022.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0022.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0022.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0022.getDate());
            priceEntity.setClosingPrice(stockDay0022.getClosingPrice());
