...
public class GetListStock0000 {
    ...
    public List<StockDayVo> getListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990000List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay0000List.get(0).getDate()));
