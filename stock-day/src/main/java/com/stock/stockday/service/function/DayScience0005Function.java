...
@Service
public class DayScience0005Function {
    @Autowired
    private StockDayScience0005Service stockDayScience0005Service;
    @Autowired
    private StockDay0005Service stockDay0005Service;

    public boolean dayScience0005Function(StockCode stockCode){
        List<StockDay0005> stockDay0005List = stockDay0005Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0005> stockDayScience0005List = new ArrayList<>();
        ...
        for (StockDay0005 stockDay0005 : stockDay0005List) {
            ...
            macdEntity.setClosingPrice(stockDay0005.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0005.getClosingPrice());
            kdjEntity.setFoot(stockDay0005.getFoot());
            kdjEntity.setTopside(stockDay0005.getTopside());
            kdjEntity.setDate(stockDay0005.getDate());
            ...
            if (stockDay0005.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0005.getChangePoints());
            }
            rsiEntity.setDate(stockDay0005.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0005.getClosingPrice());
            biasEntity.setDate(stockDay0005.getDate());
            ...
            cciEntity.setDate(stockDay0005.getDate());
            cciEntity.setClosingPrice(stockDay0005.getClosingPrice());
            cciEntity.setFoot(stockDay0005.getFoot());
            cciEntity.setTopside(stockDay0005.getTopside());
            ...
            wrEntity.setDate(stockDay0005.getDate());
            wrEntity.setClosingPrice(stockDay0005.getClosingPrice());
            wrEntity.setFoot(stockDay0005.getFoot());
            wrEntity.setTopside(stockDay0005.getTopside());
            ...
            bollEntity.setDate(stockDay0005.getDate());
            bollEntity.setClosingPrice(stockDay0005.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0005.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0005.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0005.getDate());
            priceEntity.setClosingPrice(stockDay0005.getClosingPrice());
