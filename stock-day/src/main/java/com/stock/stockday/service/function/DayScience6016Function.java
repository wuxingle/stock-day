...
@Service
public class DayScience6016Function {
    @Autowired
    private StockDayScience6016Service stockDayScience6016Service;
    @Autowired
    private StockDay6016Service stockDay6016Service;

    public boolean dayScience6016Function(StockCode stockCode){
        List<StockDay6016> stockDay6016List = stockDay6016Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6016> stockDayScience6016List = new ArrayList<>();
        ...
        for (StockDay6016 stockDay6016 : stockDay6016List) {
            ...
            macdEntity.setClosingPrice(stockDay6016.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6016.getClosingPrice());
            kdjEntity.setFoot(stockDay6016.getFoot());
            kdjEntity.setTopside(stockDay6016.getTopside());
            kdjEntity.setDate(stockDay6016.getDate());
            ...
            if (stockDay6016.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6016.getChangePoints());
            }
            rsiEntity.setDate(stockDay6016.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6016.getClosingPrice());
            biasEntity.setDate(stockDay6016.getDate());
            ...
            cciEntity.setDate(stockDay6016.getDate());
            cciEntity.setClosingPrice(stockDay6016.getClosingPrice());
            cciEntity.setFoot(stockDay6016.getFoot());
            cciEntity.setTopside(stockDay6016.getTopside());
            ...
            wrEntity.setDate(stockDay6016.getDate());
            wrEntity.setClosingPrice(stockDay6016.getClosingPrice());
            wrEntity.setFoot(stockDay6016.getFoot());
            wrEntity.setTopside(stockDay6016.getTopside());
            ...
            bollEntity.setDate(stockDay6016.getDate());
            bollEntity.setClosingPrice(stockDay6016.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6016.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6016.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6016.getDate());
            priceEntity.setClosingPrice(stockDay6016.getClosingPrice());
