...
@Service
public class DayScience0008Function {
    @Autowired
    private StockDayScience0008Service stockDayScience0008Service;
    @Autowired
    private StockDay0008Service stockDay0008Service;

    public boolean dayScience0008Function(StockCode stockCode){
        List<StockDay0008> stockDay0008List = stockDay0008Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0008> stockDayScience0008List = new ArrayList<>();
        ...
        for (StockDay0008 stockDay0008 : stockDay0008List) {
            ...
            macdEntity.setClosingPrice(stockDay0008.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0008.getClosingPrice());
            kdjEntity.setFoot(stockDay0008.getFoot());
            kdjEntity.setTopside(stockDay0008.getTopside());
            kdjEntity.setDate(stockDay0008.getDate());
            ...
            if (stockDay0008.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0008.getChangePoints());
            }
            rsiEntity.setDate(stockDay0008.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0008.getClosingPrice());
            biasEntity.setDate(stockDay0008.getDate());
            ...
            cciEntity.setDate(stockDay0008.getDate());
            cciEntity.setClosingPrice(stockDay0008.getClosingPrice());
            cciEntity.setFoot(stockDay0008.getFoot());
            cciEntity.setTopside(stockDay0008.getTopside());
            ...
            wrEntity.setDate(stockDay0008.getDate());
            wrEntity.setClosingPrice(stockDay0008.getClosingPrice());
            wrEntity.setFoot(stockDay0008.getFoot());
            wrEntity.setTopside(stockDay0008.getTopside());
            ...
            bollEntity.setDate(stockDay0008.getDate());
            bollEntity.setClosingPrice(stockDay0008.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0008.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0008.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0008.getDate());
            priceEntity.setClosingPrice(stockDay0008.getClosingPrice());
