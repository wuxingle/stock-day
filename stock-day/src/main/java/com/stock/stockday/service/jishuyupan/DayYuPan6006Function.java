...
@Service
public class DayYuPan6006Function {
    @Autowired
    ...
    public boolean dayYuPanFunction(StockCode stockCode, List<StockDay0000> stockDay000001List) throws IOException {
        ...
        List<StockDay6006> stockDay6006List = stockDay6006Service.selectByCodeAndExPage(page,stockCode.getId(), stockCode.getEx());//日线
        ...
        List<StockDay6006> stockDay6006List1 = new ArrayList<>();
        for (StockDay6006 stockDay6006 : stockDay6006List) {
            if (stockDay6006.getOpeningPrice().compareTo(new BigDecimal(0))!=0&&stockDay6006.getOpeningPrice() != null && stockDay6006.getLclosePrice() != null&&stockDay6006.getLclosePrice().compareTo(new BigDecimal(0))!=0&&stockDay6006.getChangePoints()!=null) {
                stockDay6006List1.add(stockDay6006);
            }
            if (stockDay6006List1.size() == 40) {
                for (int i = 0; i < stockDay6006List1.size(); i++) {
                    if (i ==20) {
                        DangRiEntity dangRiEntity = new DangRiEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), dangRiEntity);
                        dangRiEntityList.add(dangRiEntity);
                    }
                    if (i<24&&i > 19) {
                        WuYunEntity wuYunEntity = new WuYunEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), wuYunEntity);
                        wuYunEntityList.add(wuYunEntity);
                    }
                    if (i<25&&i >=20) {
                        CengDieEntity cengDieEntity = new CengDieEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), cengDieEntity);
                        cengDieEntityList.add(cengDieEntity);
                    }
                    if (i<30&&i >=20) {
                        PingDingEntity pingDingEntity = new PingDingEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), pingDingEntity);
                        pingDingEntityList.add(pingDingEntity);

                        SunEntity sunEntity = new SunEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), sunEntity);
                        sunEntityList.add(sunEntity);
                    }
                    if (i>=20) {
                        ChangeEntity changeEntity = new ChangeEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), changeEntity);
                        changeEntityList.add(changeEntity);
                    }
                    if (i<20) {
                        YanPanEntity yanPanEntity = new YanPanEntity();
                        BeanUtils.copyProperties(stockDay6006List1.get(i), yanPanEntity);
                ...
                for (StockDayScience6006 stockDayScience6006 : stockDayScience6006List) {
                    if (stockDay6006List1.get(20).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                    ...
                    if (stockDay6006List1.get(21).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(22).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(23).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(24).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(25).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(26).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(27).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(28).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6006List1.get(29).getDate().compareTo(stockDayScience6006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                for (StockDay0000 stockDay399001 : stockDay000001List) {
                    if (stockDay6006List1.get(20).getDate().compareTo(stockDay399001.getDate()) == 0) {
                    ...
                    if (stockDay6006List1.get(21).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(22).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(23).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(24).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(25).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(26).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(27).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(28).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(29).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(30).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(31).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(32).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(33).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(34).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(35).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(36).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(37).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(38).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6006List1.get(39).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
