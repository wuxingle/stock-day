...
@Service
public class DayScience0006Function {
    @Autowired
    private StockDayScience0006Service stockDayScience0006Service;
    @Autowired
    private StockDay0006Service stockDay0006Service;

    public boolean dayScience0006Function(StockCode stockCode){
        List<StockDay0006> stockDay0006List = stockDay0006Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0006> stockDayScience0006List = new ArrayList<>();
        ...
        for (StockDay0006 stockDay0006 : stockDay0006List) {
            ...
            macdEntity.setClosingPrice(stockDay0006.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0006.getClosingPrice());
            kdjEntity.setFoot(stockDay0006.getFoot());
            kdjEntity.setTopside(stockDay0006.getTopside());
            kdjEntity.setDate(stockDay0006.getDate());
            ...
            if (stockDay0006.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0006.getChangePoints());
            }
            rsiEntity.setDate(stockDay0006.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0006.getClosingPrice());
            biasEntity.setDate(stockDay0006.getDate());
            ...
            cciEntity.setDate(stockDay0006.getDate());
            cciEntity.setClosingPrice(stockDay0006.getClosingPrice());
            cciEntity.setFoot(stockDay0006.getFoot());
            cciEntity.setTopside(stockDay0006.getTopside());
            ...
            wrEntity.setDate(stockDay0006.getDate());
            wrEntity.setClosingPrice(stockDay0006.getClosingPrice());
            wrEntity.setFoot(stockDay0006.getFoot());
            wrEntity.setTopside(stockDay0006.getTopside());
            ...
            bollEntity.setDate(stockDay0006.getDate());
            bollEntity.setClosingPrice(stockDay0006.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0006.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0006.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0006.getDate());
            priceEntity.setClosingPrice(stockDay0006.getClosingPrice());
