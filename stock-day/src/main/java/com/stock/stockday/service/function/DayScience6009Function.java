...
@Service
public class DayScience6009Function {
    @Autowired
    private StockDayScience6009Service stockDayScience6009Service;
    @Autowired
    private StockDay6009Service stockDay6009Service;

    public boolean dayScience6009Function(StockCode stockCode){
        List<StockDay6009> stockDay6009List = stockDay6009Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6009> stockDayScience6009List = new ArrayList<>();
        ...
        for (StockDay6009 stockDay6009 : stockDay6009List) {
            ...
            macdEntity.setClosingPrice(stockDay6009.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6009.getClosingPrice());
            kdjEntity.setFoot(stockDay6009.getFoot());
            kdjEntity.setTopside(stockDay6009.getTopside());
            kdjEntity.setDate(stockDay6009.getDate());
            ...
            if (stockDay6009.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6009.getChangePoints());
            }
            rsiEntity.setDate(stockDay6009.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6009.getClosingPrice());
            biasEntity.setDate(stockDay6009.getDate());
            ...
            cciEntity.setDate(stockDay6009.getDate());
            cciEntity.setClosingPrice(stockDay6009.getClosingPrice());
            cciEntity.setFoot(stockDay6009.getFoot());
            cciEntity.setTopside(stockDay6009.getTopside());
            ...
            wrEntity.setDate(stockDay6009.getDate());
            wrEntity.setClosingPrice(stockDay6009.getClosingPrice());
            wrEntity.setFoot(stockDay6009.getFoot());
            wrEntity.setTopside(stockDay6009.getTopside());
            ...
            bollEntity.setDate(stockDay6009.getDate());
            bollEntity.setClosingPrice(stockDay6009.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6009.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6009.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6009.getDate());
            priceEntity.setClosingPrice(stockDay6009.getClosingPrice());
