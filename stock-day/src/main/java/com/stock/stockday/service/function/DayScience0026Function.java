...
@Service
public class DayScience0026Function {
    @Autowired
    private StockDayScience0026Service stockDayScience0026Service;
    @Autowired
    private StockDay0026Service stockDay0026Service;

    public boolean dayScience0026Function(StockCode stockCode){
        List<StockDay0026> stockDay0026List = stockDay0026Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0026> stockDayScience0026List = new ArrayList<>();
        ...
        for (StockDay0026 stockDay0026 : stockDay0026List) {
            ...
            macdEntity.setClosingPrice(stockDay0026.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0026.getClosingPrice());
            kdjEntity.setFoot(stockDay0026.getFoot());
            kdjEntity.setTopside(stockDay0026.getTopside());
            kdjEntity.setDate(stockDay0026.getDate());
            ...
            if (stockDay0026.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0026.getChangePoints());
            }
            rsiEntity.setDate(stockDay0026.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0026.getClosingPrice());
            biasEntity.setDate(stockDay0026.getDate());
            ...
            cciEntity.setDate(stockDay0026.getDate());
            cciEntity.setClosingPrice(stockDay0026.getClosingPrice());
            cciEntity.setFoot(stockDay0026.getFoot());
            cciEntity.setTopside(stockDay0026.getTopside());
            ...
            wrEntity.setDate(stockDay0026.getDate());
            wrEntity.setClosingPrice(stockDay0026.getClosingPrice());
            wrEntity.setFoot(stockDay0026.getFoot());
            wrEntity.setTopside(stockDay0026.getTopside());
            ...
            bollEntity.setDate(stockDay0026.getDate());
            bollEntity.setClosingPrice(stockDay0026.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0026.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0026.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0026.getDate());
            priceEntity.setClosingPrice(stockDay0026.getClosingPrice());
