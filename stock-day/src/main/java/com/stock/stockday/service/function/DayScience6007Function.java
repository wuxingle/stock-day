...
@Service
public class DayScience6007Function {
    @Autowired
    private StockDayScience6007Service stockDayScience6007Service;
    @Autowired
    private StockDay6007Service stockDay6007Service;

    public boolean dayScience6007Function(StockCode stockCode){
        List<StockDay6007> stockDay6007List = stockDay6007Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6007> stockDayScience6007List = new ArrayList<>();
        ...
        for (StockDay6007 stockDay6007 : stockDay6007List) {
            ...
            macdEntity.setClosingPrice(stockDay6007.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6007.getClosingPrice());
            kdjEntity.setFoot(stockDay6007.getFoot());
            kdjEntity.setTopside(stockDay6007.getTopside());
            kdjEntity.setDate(stockDay6007.getDate());
            ...
            if (stockDay6007.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6007.getChangePoints());
            }
            rsiEntity.setDate(stockDay6007.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6007.getClosingPrice());
            biasEntity.setDate(stockDay6007.getDate());
            ...
            cciEntity.setDate(stockDay6007.getDate());
            cciEntity.setClosingPrice(stockDay6007.getClosingPrice());
            cciEntity.setFoot(stockDay6007.getFoot());
            cciEntity.setTopside(stockDay6007.getTopside());
            ...
            wrEntity.setDate(stockDay6007.getDate());
            wrEntity.setClosingPrice(stockDay6007.getClosingPrice());
            wrEntity.setFoot(stockDay6007.getFoot());
            wrEntity.setTopside(stockDay6007.getTopside());
            ...
            bollEntity.setDate(stockDay6007.getDate());
            bollEntity.setClosingPrice(stockDay6007.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6007.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6007.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6007.getDate());
            priceEntity.setClosingPrice(stockDay6007.getClosingPrice());
