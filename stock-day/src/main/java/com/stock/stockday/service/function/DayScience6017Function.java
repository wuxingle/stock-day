...
@Service
public class DayScience6017Function {
    @Autowired
    private StockDayScience6017Service stockDayScience6017Service;
    @Autowired
    private StockDay6017Service stockDay6017Service;

    public boolean dayScience6017Function(StockCode stockCode){
        List<StockDay6017> stockDay6017List = stockDay6017Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6017> stockDayScience6017List = new ArrayList<>();
        ...
        for (StockDay6017 stockDay6017 : stockDay6017List) {
            ...
            macdEntity.setClosingPrice(stockDay6017.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6017.getClosingPrice());
            kdjEntity.setFoot(stockDay6017.getFoot());
            kdjEntity.setTopside(stockDay6017.getTopside());
            kdjEntity.setDate(stockDay6017.getDate());
            ...
            if (stockDay6017.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6017.getChangePoints());
            }
            rsiEntity.setDate(stockDay6017.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6017.getClosingPrice());
            biasEntity.setDate(stockDay6017.getDate());
            ...
            cciEntity.setDate(stockDay6017.getDate());
            cciEntity.setClosingPrice(stockDay6017.getClosingPrice());
            cciEntity.setFoot(stockDay6017.getFoot());
            cciEntity.setTopside(stockDay6017.getTopside());
            ...
            wrEntity.setDate(stockDay6017.getDate());
            wrEntity.setClosingPrice(stockDay6017.getClosingPrice());
            wrEntity.setFoot(stockDay6017.getFoot());
            wrEntity.setTopside(stockDay6017.getTopside());
            ...
            bollEntity.setDate(stockDay6017.getDate());
            bollEntity.setClosingPrice(stockDay6017.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6017.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6017.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6017.getDate());
            priceEntity.setClosingPrice(stockDay6017.getClosingPrice());
