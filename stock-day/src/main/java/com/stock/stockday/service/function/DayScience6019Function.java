...
@Service
public class DayScience6019Function {
    @Autowired
    private StockDayScience6019Service stockDayScience6019Service;
    @Autowired
    private StockDay6019Service stockDay6019Service;

    public boolean dayScience6019Function(StockCode stockCode){
        List<StockDay6019> stockDay6019List = stockDay6019Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6019> stockDayScience6019List = new ArrayList<>();
        ...
        for (StockDay6019 stockDay6019 : stockDay6019List) {
            ...
            macdEntity.setClosingPrice(stockDay6019.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6019.getClosingPrice());
            kdjEntity.setFoot(stockDay6019.getFoot());
            kdjEntity.setTopside(stockDay6019.getTopside());
            kdjEntity.setDate(stockDay6019.getDate());
            ...
            if (stockDay6019.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6019.getChangePoints());
            }
            rsiEntity.setDate(stockDay6019.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6019.getClosingPrice());
            biasEntity.setDate(stockDay6019.getDate());
            ...
            cciEntity.setDate(stockDay6019.getDate());
            cciEntity.setClosingPrice(stockDay6019.getClosingPrice());
            cciEntity.setFoot(stockDay6019.getFoot());
            cciEntity.setTopside(stockDay6019.getTopside());
            ...
            wrEntity.setDate(stockDay6019.getDate());
            wrEntity.setClosingPrice(stockDay6019.getClosingPrice());
            wrEntity.setFoot(stockDay6019.getFoot());
            wrEntity.setTopside(stockDay6019.getTopside());
            ...
            bollEntity.setDate(stockDay6019.getDate());
            bollEntity.setClosingPrice(stockDay6019.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6019.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6019.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6019.getDate());
            priceEntity.setClosingPrice(stockDay6019.getClosingPrice());
