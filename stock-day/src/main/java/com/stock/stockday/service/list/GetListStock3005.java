...
public class GetListStock3005 {
    ...
    public List<StockDayVo> getListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399006List) throws IOException {
