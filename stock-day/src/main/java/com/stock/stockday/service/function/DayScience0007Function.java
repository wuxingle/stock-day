...
@Service
public class DayScience0007Function {
    @Autowired
    private StockDayScience0007Service stockDayScience0007Service;
    @Autowired
    private StockDay0007Service stockDay0007Service;

    public boolean dayScience0007Function(StockCode stockCode){
        List<StockDay0007> stockDay0007List = stockDay0007Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0007> stockDayScience0007List = new ArrayList<>();
        ...
        for (StockDay0007 stockDay0007 : stockDay0007List) {
            ...
            macdEntity.setClosingPrice(stockDay0007.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0007.getClosingPrice());
            kdjEntity.setFoot(stockDay0007.getFoot());
            kdjEntity.setTopside(stockDay0007.getTopside());
            kdjEntity.setDate(stockDay0007.getDate());
            ...
            if (stockDay0007.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0007.getChangePoints());
            }
            rsiEntity.setDate(stockDay0007.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0007.getClosingPrice());
            biasEntity.setDate(stockDay0007.getDate());
            ...
            cciEntity.setDate(stockDay0007.getDate());
            cciEntity.setClosingPrice(stockDay0007.getClosingPrice());
            cciEntity.setFoot(stockDay0007.getFoot());
            cciEntity.setTopside(stockDay0007.getTopside());
            ...
            wrEntity.setDate(stockDay0007.getDate());
            wrEntity.setClosingPrice(stockDay0007.getClosingPrice());
            wrEntity.setFoot(stockDay0007.getFoot());
            wrEntity.setTopside(stockDay0007.getTopside());
            ...
            bollEntity.setDate(stockDay0007.getDate());
            bollEntity.setClosingPrice(stockDay0007.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0007.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0007.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0007.getDate());
            priceEntity.setClosingPrice(stockDay0007.getClosingPrice());
