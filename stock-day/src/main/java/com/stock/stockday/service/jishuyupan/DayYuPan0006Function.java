...
@Service
public class DayYuPan0006Function {
    @Autowired
    ...
    public boolean dayYuPanFunction(StockCode stockCode, List<StockDay399> stockDay399001List) throws IOException {
        ...
        List<StockDay0006> stockDay0006List = stockDay0006Service.selectByCodeAndExPage(page,stockCode.getId(), stockCode.getEx());//日线
        ...
        for (StockDay0006 stockDay0006 : stockDay0006List) {
            ...
            if (stockDay0006List1.size() == 40) {
                ...
                for (StockDayScience0006 stockDayScience0006 : stockDayScience0006List) {
                    if (stockDay0006List1.get(20).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                    ...
                    if (stockDay0006List1.get(21).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(22).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(23).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(24).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(25).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(26).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(27).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(28).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0006List1.get(29).getDate().compareTo(stockDayScience0006.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0006, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                for (StockDay399 stockDay399001 : stockDay399001List) {
                    if (stockDay0006List1.get(20).getDate().compareTo(stockDay399001.getDate()) == 0) {
                    ...
                    if (stockDay0006List1.get(21).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(22).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(23).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(24).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(25).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(26).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(27).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(28).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(29).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(30).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(31).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(32).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(33).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(34).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(35).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(36).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(37).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(38).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0006List1.get(39).getDate().compareTo(stockDay399001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay399001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
