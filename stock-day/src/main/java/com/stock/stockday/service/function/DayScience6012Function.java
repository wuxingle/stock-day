...
@Service
public class DayScience6012Function {
    @Autowired
    private StockDayScience6012Service stockDayScience6012Service;
    @Autowired
    private StockDay6012Service stockDay6012Service;

    public boolean dayScience6012Function(StockCode stockCode){
        List<StockDay6012> stockDay6012List = stockDay6012Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6012> stockDayScience6012List = new ArrayList<>();
        ...
        for (StockDay6012 stockDay6012 : stockDay6012List) {
            ...
            macdEntity.setClosingPrice(stockDay6012.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6012.getClosingPrice());
            kdjEntity.setFoot(stockDay6012.getFoot());
            kdjEntity.setTopside(stockDay6012.getTopside());
            kdjEntity.setDate(stockDay6012.getDate());
            ...
            if (stockDay6012.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6012.getChangePoints());
            }
            rsiEntity.setDate(stockDay6012.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6012.getClosingPrice());
            biasEntity.setDate(stockDay6012.getDate());
            ...
            cciEntity.setDate(stockDay6012.getDate());
            cciEntity.setClosingPrice(stockDay6012.getClosingPrice());
            cciEntity.setFoot(stockDay6012.getFoot());
            cciEntity.setTopside(stockDay6012.getTopside());
            ...
            wrEntity.setDate(stockDay6012.getDate());
            wrEntity.setClosingPrice(stockDay6012.getClosingPrice());
            wrEntity.setFoot(stockDay6012.getFoot());
            wrEntity.setTopside(stockDay6012.getTopside());
            ...
            bollEntity.setDate(stockDay6012.getDate());
            bollEntity.setClosingPrice(stockDay6012.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6012.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6012.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6012.getDate());
            priceEntity.setClosingPrice(stockDay6012.getClosingPrice());
