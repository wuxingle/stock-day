...
@Service
public class DaySaveFileKmqtd0024Function {
    @Autowired
        ...
        for (StockDay0024 stockDay0024 : stockDay0024List) {
            ...
            if (stockDay0024List1.size() == 40) {
                ...
                for (StockDayScience0024 stockDayScience0024 : stockDayScience0024List) {
                    if (stockDay0024List1.get(10).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                    ...
                    if (stockDay0024List1.get(11).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(12).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(13).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(14).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(15).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(16).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(17).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(18).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0024List1.get(19).getDate().compareTo(stockDayScience0024.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0024, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
