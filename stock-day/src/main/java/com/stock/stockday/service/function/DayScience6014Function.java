...
@Service
public class DayScience6014Function {
    @Autowired
    private StockDayScience6014Service stockDayScience6014Service;
    @Autowired
    private StockDay6014Service stockDay6014Service;

    public boolean dayScience6014Function(StockCode stockCode){
        List<StockDay6014> stockDay6014List = stockDay6014Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience6014> stockDayScience6014List = new ArrayList<>();
        ...
        for (StockDay6014 stockDay6014 : stockDay6014List) {
            ...
            macdEntity.setClosingPrice(stockDay6014.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay6014.getClosingPrice());
            kdjEntity.setFoot(stockDay6014.getFoot());
            kdjEntity.setTopside(stockDay6014.getTopside());
            kdjEntity.setDate(stockDay6014.getDate());
            ...
            if (stockDay6014.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay6014.getChangePoints());
            }
            rsiEntity.setDate(stockDay6014.getDate());
            ...
            biasEntity.setClosingPrice(stockDay6014.getClosingPrice());
            biasEntity.setDate(stockDay6014.getDate());
            ...
            cciEntity.setDate(stockDay6014.getDate());
            cciEntity.setClosingPrice(stockDay6014.getClosingPrice());
            cciEntity.setFoot(stockDay6014.getFoot());
            cciEntity.setTopside(stockDay6014.getTopside());
            ...
            wrEntity.setDate(stockDay6014.getDate());
            wrEntity.setClosingPrice(stockDay6014.getClosingPrice());
            wrEntity.setFoot(stockDay6014.getFoot());
            wrEntity.setTopside(stockDay6014.getTopside());
            ...
            bollEntity.setDate(stockDay6014.getDate());
            bollEntity.setClosingPrice(stockDay6014.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay6014.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay6014.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay6014.getDate());
            priceEntity.setClosingPrice(stockDay6014.getClosingPrice());
