...
@Service
public class DayScience0020Function {
    @Autowired
    private StockDayScience0020Service stockDayScience0020Service;
    @Autowired
    private StockDay0020Service stockDay0020Service;

    public boolean dayScience0020Function(StockCode stockCode){
        List<StockDay0020> stockDay0020List = stockDay0020Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0020> stockDayScience0020List = new ArrayList<>();
        ...
        for (StockDay0020 stockDay0020 : stockDay0020List) {
            ...
            macdEntity.setClosingPrice(stockDay0020.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0020.getClosingPrice());
            kdjEntity.setFoot(stockDay0020.getFoot());
            kdjEntity.setTopside(stockDay0020.getTopside());
            kdjEntity.setDate(stockDay0020.getDate());
            ...
            if (stockDay0020.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0020.getChangePoints());
            }
            rsiEntity.setDate(stockDay0020.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0020.getClosingPrice());
            biasEntity.setDate(stockDay0020.getDate());
            ...
            cciEntity.setDate(stockDay0020.getDate());
            cciEntity.setClosingPrice(stockDay0020.getClosingPrice());
            cciEntity.setFoot(stockDay0020.getFoot());
            cciEntity.setTopside(stockDay0020.getTopside());
            ...
            wrEntity.setDate(stockDay0020.getDate());
            wrEntity.setClosingPrice(stockDay0020.getClosingPrice());
            wrEntity.setFoot(stockDay0020.getFoot());
            wrEntity.setTopside(stockDay0020.getTopside());
            ...
            bollEntity.setDate(stockDay0020.getDate());
            bollEntity.setClosingPrice(stockDay0020.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0020.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0020.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0020.getDate());
            priceEntity.setClosingPrice(stockDay0020.getClosingPrice());
