...
@Service
public class DaySaveFileKmqtd6002Function {
    @Autowired
        ...
        for (StockDay6002 stockDay6002 : stockDay6002List) {
            ...
            if (stockDay6002List1.size() == 40) {
                ...
                for (StockDayScience6002 stockDayScience6002 : stockDayScience6002List) {
                    if (stockDay6002List1.get(10).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                    ...
                    if (stockDay6002List1.get(11).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(12).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(13).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(14).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(15).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(16).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(17).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(18).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6002List1.get(19).getDate().compareTo(stockDayScience6002.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6002, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
