...
@Service
public class DayScience0003Function {
    @Autowired
    private StockDayScience0003Service stockDayScience0003Service;
    @Autowired
    private StockDay0003Service stockDay0003Service;

    public boolean dayScience0003Function(StockCode stockCode){
        List<StockDay0003> stockDay0003List = stockDay0003Service.selectByCodeAndEx(stockCode.getId(), stockCode.getEx());
        List<StockDayScience0003> stockDayScience0003List = new ArrayList<>();
        ...
        for (StockDay0003 stockDay0003 : stockDay0003List) {
            ...
            macdEntity.setClosingPrice(stockDay0003.getClosingPrice());
            ...
            kdjEntity.setClosingPrice(stockDay0003.getClosingPrice());
            kdjEntity.setFoot(stockDay0003.getFoot());
            kdjEntity.setTopside(stockDay0003.getTopside());
            kdjEntity.setDate(stockDay0003.getDate());
            ...
            if (stockDay0003.getChangePoints() == null) {
                rsiEntity.setChangePoints(new BigDecimal(0));
            } else {
                rsiEntity.setChangePoints(stockDay0003.getChangePoints());
            }
            rsiEntity.setDate(stockDay0003.getDate());
            ...
            biasEntity.setClosingPrice(stockDay0003.getClosingPrice());
            biasEntity.setDate(stockDay0003.getDate());
            ...
            cciEntity.setDate(stockDay0003.getDate());
            cciEntity.setClosingPrice(stockDay0003.getClosingPrice());
            cciEntity.setFoot(stockDay0003.getFoot());
            cciEntity.setTopside(stockDay0003.getTopside());
            ...
            wrEntity.setDate(stockDay0003.getDate());
            wrEntity.setClosingPrice(stockDay0003.getClosingPrice());
            wrEntity.setFoot(stockDay0003.getFoot());
            wrEntity.setTopside(stockDay0003.getTopside());
            ...
            bollEntity.setDate(stockDay0003.getDate());
            bollEntity.setClosingPrice(stockDay0003.getClosingPrice());
            ...
            makeQuantityEntity.setDate(stockDay0003.getDate());
            makeQuantityEntity.setMakeQuantity(stockDay0003.getMakeQuantity());
            ...
            priceEntity.setDate(stockDay0003.getDate());
            priceEntity.setClosingPrice(stockDay0003.getClosingPrice());
