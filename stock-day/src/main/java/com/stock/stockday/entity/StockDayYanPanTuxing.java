...
@Data
@TableName("stock_day_yan_pan_tuxing")
public class StockDayYanPanTuxing implements Serializable {
    private static final long serialVersionUID = 1L;
    @TableId
    private String id;
    private String benPiao2;
    private String benPiao3;
    private String benPiao5;
    private String benPiao8;
    private String benPiao13;
    private String benPiao20;
    private String dangRi;
    private String liangXian;
    private String sanXian;
    private String siXian;
    private String wuXian;
    private String duoXian;
