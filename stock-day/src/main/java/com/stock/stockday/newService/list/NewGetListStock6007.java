...
@Service
public class NewGetListStock6007 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay0000> stockDay000001List) throws IOException {
        ...
        List<StockDay6007> stockDay6007List = stockDay6007Service.selectByCodeAndExPage(page, stockCode.getId(), stockCode.getEx());
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay6007List.get(0).getDate()));
        Page<StockDayScience6007> page1=new Page<>(1,60);
        List<StockDayScience6007> stockDayScience6007List = stockDayScience6007Service.selectByPage(page1,stockCode.getId(), stockCode.getEx());//技术先
        //计算指标，从数据库中获取对于的数据
        ...
        List<StockDay6007> stockDay6007List1 = new ArrayList<>();
        for (StockDay6007 stockDay6007 : stockDay6007List) {
            if (stockDay6007.getOpeningPrice().compareTo(new BigDecimal(0)) != 0 && stockDay6007.getOpeningPrice() != null && stockDay6007.getLclosePrice() != null && stockDay6007.getLclosePrice().compareTo(new BigDecimal(0)) != 0 && stockDay6007.getChangePoints() != null) {
                stockDay6007List1.add(stockDay6007);
            }
            if (stockDay6007List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay6007List1.get(0).getDate()));
                for (int i = 0; i < stockDay6007List1.size(); i++) {
                    if (i == 0) {
                        DangRiEntity dangRiEntity = new DangRiEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), dangRiEntity);
                        dangRiEntityList.add(dangRiEntity);
                    }
                    if (i < 4) {
                        WuYunEntity wuYunEntity = new WuYunEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), wuYunEntity);
                        wuYunEntityList.add(wuYunEntity);
                    }
                    if ( i < 5) {
                        CengDieEntity cengDieEntity = new CengDieEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), cengDieEntity);
                        cengDieEntityList.add(cengDieEntity);
                    }
                    if (i < 10) {
                        PingDingEntity pingDingEntity = new PingDingEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), pingDingEntity);
                        pingDingEntityList.add(pingDingEntity);

                        SunEntity sunEntity = new SunEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), sunEntity);
                        sunEntityList.add(sunEntity);
                    }
                    if (i < 20) {
                        ChangeEntity changeEntity = new ChangeEntity();
                        BeanUtils.copyProperties(stockDay6007List1.get(i), changeEntity);
                ...
                for (StockDayScience6007 stockDayScience6007 : stockDayScience6007List) {
                    if (stockDay6007List1.get(0).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(1).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(2).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(3).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(4).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(5).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(6).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(7).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(8).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6007List1.get(9).getDate().compareTo(stockDayScience6007.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6007, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay0000 stockDay3996007 : stockDay000001List) {
                    if (stockDay6007List1.get(0).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(1).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(2).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(3).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(4).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(5).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(6).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(7).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(8).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(9).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(10).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(11).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(12).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(13).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(14).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(15).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(16).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(17).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(18).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6007List1.get(19).getDate().compareTo(stockDay3996007.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996007, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
