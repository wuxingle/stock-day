...
@Service
public class NewGetListStock001 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399001List) throws IOException {
        ...
        for (StockDay001 stockDay001 : stockDay001List) {
            ...
            if (stockDay001List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay001List1.get(0).getDate()));
                ...
                for (StockDayScience001 stockDayScience001 : stockDayScience001List) {
                    if (stockDay001List1.get(0).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                    ...
                    if (stockDay001List1.get(1).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(2).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(3).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(4).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(5).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(6).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(7).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(8).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay001List1.get(9).getDate().compareTo(stockDayScience001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
    ...
    public List<StockDayVo> getKmQRListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getQTuXingListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
