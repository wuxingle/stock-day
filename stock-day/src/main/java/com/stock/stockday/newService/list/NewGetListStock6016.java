...
@Service
public class NewGetListStock6016 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay0000> stockDay000001List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay6016List.get(0).getDate()));
        ...
        for (StockDay6016 stockDay6016 : stockDay6016List) {
            ...
            if (stockDay6016List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay6016List1.get(0).getDate()));
                ...
                for (StockDayScience6016 stockDayScience6016 : stockDayScience6016List) {
                    if (stockDay6016List1.get(0).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                    ...
                    if (stockDay6016List1.get(1).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(2).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(3).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(4).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(5).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(6).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(7).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(8).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6016List1.get(9).getDate().compareTo(stockDayScience6016.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6016, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay0000 stockDay3996016 : stockDay000001List) {
                    if (stockDay6016List1.get(0).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(1).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(2).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(3).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(4).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(5).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(6).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(7).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(8).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(9).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(10).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(11).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(12).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(13).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(14).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(15).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(16).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(17).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(18).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6016List1.get(19).getDate().compareTo(stockDay3996016.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996016, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
