...
@Service
public class NewGetListStock0023 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399005List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay0023List.get(0).getDate()));
        ...
        for (StockDay0023 stockDay0023 : stockDay0023List) {
            ...
            if (stockDay0023List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay0023List1.get(0).getDate()));
                ...
                for (StockDayScience0023 stockDayScience0023 : stockDayScience0023List) {
                    if (stockDay0023List1.get(0).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                    ...
                    if (stockDay0023List1.get(1).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(2).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(3).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(4).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(5).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(6).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(7).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(8).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0023List1.get(9).getDate().compareTo(stockDayScience0023.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0023, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay399 stockDay3990023 : stockDay399005List) {
                    if (stockDay0023List1.get(0).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(1).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(2).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(3).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(4).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(5).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(6).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(7).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(8).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(9).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(10).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(11).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(12).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(13).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(14).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(15).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(16).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(17).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(18).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0023List1.get(19).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990023List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
        ...
        for (StockDay0023 stockDay0023 : stockDay0023List) {
            ...
            if (stockDay0023List1.size() == 20) {
                ...
                //大盘
                for (StockDay399 stockDay3990023 : stockDay3990023List) {
                    if (stockDay0023List1.get(0).getDate().compareTo(stockDay3990023.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990023, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
