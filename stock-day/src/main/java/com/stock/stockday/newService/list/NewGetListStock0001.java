...
@Service
public class NewGetListStock0001 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990001List) throws IOException {
        ...
        List<StockDay0001> stockDay0001List = stockDay0001Service.selectByCodeAndExPage(page, stockCode.getId(), stockCode.getEx());
        ...
        List<StockDay0001> stockDay0001List1 = new ArrayList<>();
        for (StockDay0001 stockDay0001 : stockDay0001List) {
            if (stockDay0001.getOpeningPrice().compareTo(new BigDecimal(0)) != 0 && stockDay0001.getOpeningPrice() != null && stockDay0001.getLclosePrice() != null && stockDay0001.getLclosePrice().compareTo(new BigDecimal(0)) != 0 && stockDay0001.getChangePoints() != null) {
                stockDay0001List1.add(stockDay0001);
            }
            if (stockDay0001List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay0001List1.get(0).getDate()));
                for (int i = 0; i < stockDay0001List1.size(); i++) {
                    if (i == 0) {
                        DangRiEntity dangRiEntity = new DangRiEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), dangRiEntity);
                        dangRiEntityList.add(dangRiEntity);
                    }
                    if (i < 4) {
                        WuYunEntity wuYunEntity = new WuYunEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), wuYunEntity);
                        wuYunEntityList.add(wuYunEntity);
                    }
                    if ( i < 5) {
                        CengDieEntity cengDieEntity = new CengDieEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), cengDieEntity);
                        cengDieEntityList.add(cengDieEntity);
                    }
                    if (i < 10) {
                        PingDingEntity pingDingEntity = new PingDingEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), pingDingEntity);
                        pingDingEntityList.add(pingDingEntity);

                        SunEntity sunEntity = new SunEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), sunEntity);
                        sunEntityList.add(sunEntity);
                    }
                    if (i < 20) {
                        ChangeEntity changeEntity = new ChangeEntity();
                        BeanUtils.copyProperties(stockDay0001List1.get(i), changeEntity);
                ...
                for (StockDayScience0001 stockDayScience0001 : stockDayScience0001List) {
                    if (stockDay0001List1.get(0).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(1).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(2).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(3).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(4).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(5).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(6).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(7).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(8).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0001List1.get(9).getDate().compareTo(stockDayScience0001.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0001, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay399 stockDay3990001 : stockDay3990001List) {
                    if (stockDay0001List1.get(0).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(1).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(2).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(3).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(4).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(5).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(6).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(7).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(8).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(9).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(10).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(11).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(12).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(13).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(14).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(15).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(16).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(17).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(18).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0001List1.get(19).getDate().compareTo(stockDay3990001.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990001, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
    ...
    public List<StockDayVo> getKmQRListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getQTuXingListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990001List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
