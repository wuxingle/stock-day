...
@Service
public class NewGetListStock0008 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990008List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay0008List.get(0).getDate()));
        ...
        List<StockDay0008> stockDay0008List1 = new ArrayList<>();
        for (StockDay0008 stockDay0008 : stockDay0008List) {
            if (stockDay0008.getOpeningPrice().compareTo(new BigDecimal(0)) != 0 && stockDay0008.getOpeningPrice() != null && stockDay0008.getLclosePrice() != null && stockDay0008.getLclosePrice().compareTo(new BigDecimal(0)) != 0 && stockDay0008.getChangePoints() != null) {
                stockDay0008List1.add(stockDay0008);
            }
            if (stockDay0008List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay0008List1.get(0).getDate()));
                for (int i = 0; i < stockDay0008List1.size(); i++) {
                    if (i == 0) {
                        DangRiEntity dangRiEntity = new DangRiEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), dangRiEntity);
                        dangRiEntityList.add(dangRiEntity);
                    }
                    if (i < 4) {
                        WuYunEntity wuYunEntity = new WuYunEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), wuYunEntity);
                        wuYunEntityList.add(wuYunEntity);
                    }
                    if ( i < 5) {
                        CengDieEntity cengDieEntity = new CengDieEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), cengDieEntity);
                        cengDieEntityList.add(cengDieEntity);
                    }
                    if (i < 10) {
                        PingDingEntity pingDingEntity = new PingDingEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), pingDingEntity);
                        pingDingEntityList.add(pingDingEntity);

                        SunEntity sunEntity = new SunEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), sunEntity);
                        sunEntityList.add(sunEntity);
                    }
                    if (i < 20) {
                        ChangeEntity changeEntity = new ChangeEntity();
                        BeanUtils.copyProperties(stockDay0008List1.get(i), changeEntity);
                ...
                for (StockDayScience0008 stockDayScience0008 : stockDayScience0008List) {
                    if (stockDay0008List1.get(0).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                    ...
                    if (stockDay0008List1.get(1).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(2).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(3).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(4).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(5).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(6).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(7).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(8).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0008List1.get(9).getDate().compareTo(stockDayScience0008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay399 stockDay3990008 : stockDay3990008List) {
                    if (stockDay0008List1.get(0).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(1).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(2).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(3).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(4).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(5).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(6).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(7).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(8).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(9).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(10).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(11).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(12).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(13).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(14).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(15).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(16).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(17).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(18).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0008List1.get(19).getDate().compareTo(stockDay3990008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
    ...
    public List<StockDayVo> getKmQRListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990008List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getQTuXingListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990008List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990008List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
