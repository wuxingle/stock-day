...
@Service
public class NewGetListStock0025 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399005List) throws IOException {
        ...
        List<StockDay0025> stockDay0025List = stockDay0025Service.selectByCodeAndExPage(page, stockCode.getId(), stockCode.getEx());
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay0025List.get(0).getDate()));
        Page<StockDayScience0025> page1=new Page<>(1,60);
        List<StockDayScience0025> stockDayScience0025List = stockDayScience0025Service.selectByPage(page1,stockCode.getId(), stockCode.getEx());//技术先
        //计算指标，从数据库中获取对于的数据
        ...
        for (StockDay0025 stockDay0025 : stockDay0025List) {
            ...
            if (stockDay0025List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay0025List1.get(0).getDate()));
                ...
                for (StockDayScience0025 stockDayScience0025 : stockDayScience0025List) {
                    if (stockDay0025List1.get(0).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                    ...
                    if (stockDay0025List1.get(1).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(2).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(3).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(4).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(5).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(6).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(7).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(8).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0025List1.get(9).getDate().compareTo(stockDayScience0025.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0025, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay399 stockDay3990025 : stockDay399005List) {
                    if (stockDay0025List1.get(0).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(1).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(2).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(3).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(4).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(5).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(6).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(7).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(8).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(9).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(10).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(11).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(12).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(13).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(14).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(15).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(16).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(17).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(18).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0025List1.get(19).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990025List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
        ...
        for (StockDay0025 stockDay0025 : stockDay0025List) {
            ...
            if (stockDay0025List1.size() == 20) {
                ...
                //大盘
                for (StockDay399 stockDay3990025 : stockDay3990025List) {
                    if (stockDay0025List1.get(0).getDate().compareTo(stockDay3990025.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990025, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
