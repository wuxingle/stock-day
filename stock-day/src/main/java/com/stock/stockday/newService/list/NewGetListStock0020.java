...
@Service
public class NewGetListStock0020 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay399005List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay0020List.get(0).getDate()));
        ...
        for (StockDay0020 stockDay0020 : stockDay0020List) {
            ...
            if (stockDay0020List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay0020List1.get(0).getDate()));
                ...
                for (StockDayScience0020 stockDayScience0020 : stockDayScience0020List) {
                    if (stockDay0020List1.get(0).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                    ...
                    if (stockDay0020List1.get(1).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(2).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(3).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(4).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(5).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(6).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(7).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(8).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay0020List1.get(9).getDate().compareTo(stockDayScience0020.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience0020, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay399 stockDay3990020 : stockDay399005List) {
                    if (stockDay0020List1.get(0).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(1).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(2).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(3).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(4).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(5).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(6).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(7).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(8).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(9).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(10).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(11).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(12).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(13).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(14).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(15).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(16).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(17).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(18).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay0020List1.get(19).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
    ...
    public List<StockDayVo> getKTu20LSListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay399> stockDay3990020List) throws IOException {
        StockDayVo stockDayVo = new StockDayVo();
        stockDayVo.setCode(stockCode.getEx() + stockCode.getId());
        stockDayVo.setName(stockCode.getName());
        //获取前60天记录，并且取前20天的有效记录
        ...
        for (StockDay0020 stockDay0020 : stockDay0020List) {
            ...
            if (stockDay0020List1.size() == 20) {
                ...
                //大盘
                for (StockDay399 stockDay3990020 : stockDay3990020List) {
                    if (stockDay0020List1.get(0).getDate().compareTo(stockDay3990020.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3990020, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
