...
@Service
public class NewGetListStock6008 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay0000> stockDay000001List) throws IOException {
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay6008List.get(0).getDate()));
        ...
        for (StockDay6008 stockDay6008 : stockDay6008List) {
            ...
            if (stockDay6008List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay6008List1.get(0).getDate()));
                ...
                for (StockDayScience6008 stockDayScience6008 : stockDayScience6008List) {
                    if (stockDay6008List1.get(0).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                    ...
                    if (stockDay6008List1.get(1).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(2).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(3).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(4).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(5).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(6).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(7).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(8).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6008List1.get(9).getDate().compareTo(stockDayScience6008.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6008, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay0000 stockDay3996008 : stockDay000001List) {
                    if (stockDay6008List1.get(0).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(1).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(2).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(3).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(4).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(5).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(6).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(7).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(8).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(9).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(10).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(11).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(12).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(13).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(14).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(15).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(16).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(17).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(18).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6008List1.get(19).getDate().compareTo(stockDay3996008.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996008, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
