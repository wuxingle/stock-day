...
@Service
public class NewGetListStock6015 {
    @Autowired
    ...
    public List<StockDayVo> getKMPTDListStock(StockCode stockCode, List<StockDayVo> stockDayVoList, List<StockDay0000> stockDay000001List) throws IOException {
        ...
        List<StockDay6015> stockDay6015List = stockDay6015Service.selectByCodeAndExPage(page, stockCode.getId(), stockCode.getEx());
        ...
        stockDayVo.setDate(DateUtil.get2String(stockDay6015List.get(0).getDate()));
        Page<StockDayScience6015> page1=new Page<>(1,60);
        List<StockDayScience6015> stockDayScience6015List = stockDayScience6015Service.selectByPage(page1,stockCode.getId(), stockCode.getEx());//技术先
        //计算指标，从数据库中获取对于的数据
        ...
        List<StockDay6015> stockDay6015List1 = new ArrayList<>();
        for (StockDay6015 stockDay6015 : stockDay6015List) {
            if (stockDay6015.getOpeningPrice().compareTo(new BigDecimal(0)) != 0 && stockDay6015.getOpeningPrice() != null && stockDay6015.getLclosePrice() != null && stockDay6015.getLclosePrice().compareTo(new BigDecimal(0)) != 0 && stockDay6015.getChangePoints() != null) {
                stockDay6015List1.add(stockDay6015);
            }
            if (stockDay6015List1.size() == 20) {
                stockDayVo.setDate(DateUtil.get2String(stockDay6015List1.get(0).getDate()));
                for (int i = 0; i < stockDay6015List1.size(); i++) {
                    if (i == 0) {
                        DangRiEntity dangRiEntity = new DangRiEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), dangRiEntity);
                        dangRiEntityList.add(dangRiEntity);
                    }
                    if (i < 4) {
                        WuYunEntity wuYunEntity = new WuYunEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), wuYunEntity);
                        wuYunEntityList.add(wuYunEntity);
                    }
                    if ( i < 5) {
                        CengDieEntity cengDieEntity = new CengDieEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), cengDieEntity);
                        cengDieEntityList.add(cengDieEntity);
                    }
                    if (i < 10) {
                        PingDingEntity pingDingEntity = new PingDingEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), pingDingEntity);
                        pingDingEntityList.add(pingDingEntity);

                        SunEntity sunEntity = new SunEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), sunEntity);
                        sunEntityList.add(sunEntity);
                    }
                    if (i < 20) {
                        ChangeEntity changeEntity = new ChangeEntity();
                        BeanUtils.copyProperties(stockDay6015List1.get(i), changeEntity);
                ...
                for (StockDayScience6015 stockDayScience6015 : stockDayScience6015List) {
                    if (stockDay6015List1.get(0).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(1).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(2).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(3).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(4).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(5).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(6).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(7).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(8).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                    if (stockDay6015List1.get(9).getDate().compareTo(stockDayScience6015.getDate()) == 0) {
                        ScienceEntity scienceEntity = new ScienceEntity();
                        BeanUtils.copyProperties(stockDayScience6015, scienceEntity);
                        scienceEntityList.add(scienceEntity);
                    }
                ...
                //大盘
                for (StockDay0000 stockDay3996015 : stockDay000001List) {
                    if (stockDay6015List1.get(0).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(1).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(2).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(3).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(4).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(5).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(6).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(7).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(8).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(9).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(10).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(11).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(12).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(13).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(14).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(15).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(16).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(17).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(18).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
                    if (stockDay6015List1.get(19).getDate().compareTo(stockDay3996015.getDate()) == 0) {
                        DaPanChangeEntity daPanChangeEntity = new DaPanChangeEntity();
                        BeanUtils.copyProperties(stockDay3996015, daPanChangeEntity);
                        daPanChangeEntityList.add(daPanChangeEntity);
                    }
